...
import 'package:bokashi/features/auth/enums/social_login_options.dart';
      ...
      if (socialLoginList.length == 1) {
        return Row(children: [
          ...
          //       )),
           ...
           //  Expanded(
           //    child: InkWell(
           //      onTap: () => _facebookLogin(context, widget.fromPage, widget.onLoginSuccess),
           //      child: SocialLoginButtonWidget(
...
// Facebook login disabled
// Future<void> _facebookLogin(BuildContext context, String? fromPage, VoidCallback? onLoginSuccess) async {
//   SocialLoginModel socialLogin = SocialLoginModel();
//
//   try {
